...
__device__ FaceVertsIdx _PLANES[] = {{0, 1, 2, 3},
                                     {3, 2, 6, 7},
                                     {0, 1, 5, 4},
                                     {0, 3, 7, 4},
                                     {1, 5, 6, 2},
                                     {4, 5, 6, 7},};
__device__ FaceVertsIdx _TRIS[] = {{0, 1, 2},
                                   {0, 3, 2},
                                   {4, 5, 6},
                                   {4, 6, 7},
                                   {1, 5, 6},
...
__device__ inline float3 PolyhedronCenter(const Tris &tris, const int num_tris) {
    float x = 0.0;
    float y = 0.0;
    float z = 0.0;
...
ClipTriByPlaneOneOut(const FaceVerts &plane, const float3 &normal, const float3 &vout, const float3 &vin1,
                     const float3 &vin2, FaceVertsBox &face_verts_out) {
...
template<typename FaceVertsBox>
__device__ inline int
ClipTriByPlaneTwoOut(const FaceVerts &plane, const float3 &normal, const float3 &vout1, const float3 &vout2,
                     const float3 &vin, FaceVertsBox &face_verts_out) {
